...
def build_data(table, out_system='Vega'):
    """Return a Wstd data str from information in table

    table is expected to be calibrated in 'AB'
    system can be 'Vega' or 'AB'
    """
    filt = table['filter']
    mjd = table['mjd']
...
def convert_ecsv_to_wstd(infile, outfile):
    """
...
if __name__ == "__main__":
    ...
    convert_ecsv_to_wstd(infile, outfile)
