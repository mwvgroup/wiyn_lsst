...
forcedPhotCcd.py "${REPO}" --rerun ${COADD_RERUN}:${FORCEDPHOT_RERUN} \
    --id field=${FIELD} seq=A filter=H night=20131209 tract=${TRACT} \
    --id field=${FIELD} seq=A filter=J night=20131111 tract=${TRACT} \
    --id field=${FIELD} seq=A filter=J night=20131120 tract=${TRACT} \
    --clobber-versions
